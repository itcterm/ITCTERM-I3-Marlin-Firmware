...
// LCD Print Progress options
  ...
  #define EVENT_GCODE_SD_ABORT "G28X;M18"      // G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
  // ####################   20220519  Mexer aqui para tentar dar só home x e disable steppers.  Era "G28XY"
 ...
 */
#define BABYSTEPPING
//############  20210320  mudanca de versao marlin.  ativei
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  10       // (steps or mm) Steps or millimeter distance for each Z babystep
   //############  20210320  mudanca de versao marlin. Valor anterior  1
 ...
 #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping.
   // ########## 20210320  ativei
    ...
    #define DOUBLECLICK_MAX_INTERVAL 1250   // Maximum interval between clicks, in milliseconds.
      // ########## 20210320  considerar mudanca.  no marlin antigo estava 900
                                            // Note: Extra time may be added to mitigate controller latency.
    #define MOVE_Z_WHEN_IDLE              // Jump to the move Z menu on doubleclick when printer is idle.
     // ########## 20210320  mudanca de versao marlin. Ativei ess
 ...
 */
//#define LIN_ADVANCE
// ########## 20210320  considerar ativar essa opcao
